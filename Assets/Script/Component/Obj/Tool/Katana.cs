...
public class Katana : HuyMonoBehaviour
{
    ...
    [SerializeField] protected CapsuleCollider2D damageCol;
    ...
    private void CheckingCol()
    {
        ...
        Vector2 size = this.damageCol.size;
        CapsuleDirection2D dir = this.damageCol.direction;
        float angle = this.damageCol.transform.eulerAngles.z;
        Collider2D[] collisions = Physics2D.OverlapCapsuleAll(pos, size, dir, angle, this.attackableLayer);
