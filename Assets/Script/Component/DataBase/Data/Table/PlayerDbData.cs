...
[Serializable]
public class PlayerDbData : GameContentDbData
{
    //==========================================Variable==========================================
    ...
    //========================================Constructor=========================================
    public PlayerDbData(string accountId, int respawnSceneIndex, Vector3 respawnPos, Vector3 respawnRot, int currSceneIndex, 
        Vector3 position, Quaternion rotation, string id, int health, float dashRestoreTimer,
        float cebRestoreTimer, bool hasDash, bool hasAirJump, bool hasCastEnergyBall) : base(id, accountId)
    {
